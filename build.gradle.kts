...
paperweight {
    serverProject.set(project(":capsaicin-server"))
    ...
    usePaperUpstream(providers.gradleProperty("paperRef")) {
        withPaperPatcher {
            ...
            apiOutputDir.set(layout.projectDirectory.dir("capsaicin-api"))

            serverPatchDir.set(layout.projectDirectory.dir("patches/server"))
            serverOutputDir.set(layout.projectDirectory.dir("capsaicin-server"))
        }
    }
}
...
tasks.generateDevelopmentBundle {
    apiCoordinates.set("com.scoville.capsaicin:capsaicin-api")
    mojangApiCoordinates.set("io.papermc.paper:paper-mojangapi")
    libraryRepositories.set(
        listOf(
            "https://repo.maven.apache.org/maven2/",
            paperMavenPublicUrl,
            // "https://my.repo/", // This should be a repo hosting your API (in this example, 'com.scoville.capsaicin:capsaicin-api')
        )
    )
}
